                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(fontSize: 15, color: Colors.black, fontFamily: 'Lato', fontWeight: FontWeight.w700,),
                    ),
                    SizedBox(height: 1),
                    Row(
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                            '1.50€',
                                style: TextStyle(fontSize: 13, color: Colors.black, fontFamily: 'Lato')
                            ),
                            SizedBox(height: 10),
                            Row(
                              children: [
                                ...
                                Text(
                                    ' $_quantity ',
                                    style: TextStyle(fontSize: 10, color: Colors.black, fontFamily: 'Lato')
                                ),
                                GestureDetector(
                                  onTap: _addQuantity,
                                  child: Padding(
